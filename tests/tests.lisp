...
(defun run-tests ()
  ...
  (let ((configuration (configuration-create
    ...
    (test-source-hotload-installation-and-replay)
    (test-source-hotload-committed-source)
    (test-source-hotload-atomic-rollback)
    (test-source-hotload-protected-kernel)
    (test-source-hotload-post-pointer-race)
    (test-source-hotload-structural-boundary)
    (test-source-hotload-successive-batches)
    (test-source-hotload-startup-conflict-atomicity)
    (test-source-hotload-clean-replay-probe)
    (test-source-hotload-clean-process-probe)
    (test-source-hotload-error-paths)
