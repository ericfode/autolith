...
show the effective session selections.
...
Browser and Modal selections are session configuration in this release. Their
runtime implementations are separate later slices; this release does not add
browser tools or redirect local shell execution.
